...
//  SDL.events.on('event', console.dir);
  ...
  var platform = {
    ...
    on: function (name, callback) {
      ...
      else if (name === "mouseup") name = "MOUSEBUTTONUP";
      else if (name === "mousedown") name = "MOUSEBUTTONDOWN";
      //else if (name === "mouseover") name = "MOUSEMOTION";
      //else if (name === "mouseout") name = "MOUSEMOTION";
      else if (name === "keydown") name = "KEYDOWN";
    ...
    removeEventListener: function(name,callback) {
      ...
      //else if (name === "mouseover") name = "MOUSEMOTION";
      //else if (name === "mouseout") name = "MOUSEMOTION";
      else if (name === "resize") name = "VIDEORESIZE";
