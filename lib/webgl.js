...
gl.WebGLActiveInfo=function (_) { this._ = _; }
gl.WebGLUniformLocation=function (_) { this._ = _; }

exports.WebGLBuffer=gl.WebGLBuffer;
...
gl.texImage2D = function texImage2D(target, level, internalformat, width, height, border, format, type, pixels) {
  if (!(arguments.length === 9 && typeof target === "number" && typeof level === "number" && typeof internalformat === "number" && typeof width === "number" && typeof height === "number" && typeof border === "number" && typeof format === "number" && typeof type === "number" && 
...
gl.uniform1f = function uniform1f(location, x) {
  if (!(arguments.length === 2 && (location === null || location instanceof gl.WebGLUniformLocation) && typeof x === "number")) {
